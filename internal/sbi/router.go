...
func newRouter(s *Server) *gin.Engine {
	...
	addMessageGroup := router.Group("/message")
	applyRoutes(addMessageGroup, s.putMessageRoute())

	getMessageGroup := router.Group("/message")
	applyRoutes(getMessageGroup, s.getMessageRoute())
